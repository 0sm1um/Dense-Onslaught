...
dlc_bastion.dense_bastion_gate_event = {
    {
...
dlc_bastion.dense_bastion_finale_event = {
    {
        "enable_bots_in_carry_event"
    },
    {
...
dlc_bastion.dense_bastion_event_rat_ogre = {
    {
        "set_master_event_running",
...
dlc_bastion.dense_bastion_event_storm_fiend = {
    {
        "set_master_event_running",
        name = "bastion_event_boss"
    },
...
dlc_bastion.dense_bastion_event_chaos_spawn = {
    {
        "set_master_event_running",
        name = "bastion_event_boss"
    },
...
dlc_bastion.dense_bastion_finale_event_gauntlet = {
    {
        "event_horde",
        limit_spawners = 5,
        spawner_id = "bastion_finale_event_escape",
